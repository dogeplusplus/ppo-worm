...
class PPOActorCritic(nn.Module):
    ...
    def __init__(self, observation_space, action_space, hidden_sizes=(64, 64), activation=nn.Tanh):
        ...
        # Unity vs Gym
        if isinstance(observation_space, ObservationSpec):
        ...
        elif isinstance(action_space, ActionSpec):
            self.pi = PPOGaussianActor(obs_dim, action_space[0], hidden_sizes, activation)
        else:
